...
public final class Constants {
  ...
  // NOTE: We are running the drive motors in open loop mode, using only the
  // feedfoward.
  ...
  // Module Index, Drive Motor Channel, Swerve Motor Channel, Analog Encoder
  // Channel
  ...
  // static public double[] kZeroPosition = new double[]{0.963, 0.486, 0.070,
  // 0.093};
  static public double[] kZeroPosition = new double[] { 0.963, 0.486, 0.710, 0.093 };
  static public double kEncoderRes = 4096;

  // TODO: Fixme
  // static public HolonomicPathFollowerConfig kPathFollowerConfig = new HolonomicPathFollowerConfig(
